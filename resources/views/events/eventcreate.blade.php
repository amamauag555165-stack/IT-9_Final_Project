        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="mb-0 text-muted">Organization: {{ $organization->organization_name }}</p>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('events.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('required_volunteers') is-invalid @enderror" 
                                   id="required_volunteers" name="required_volunteers" value="{{ old('required_volunteers') }}" min="1" required>
